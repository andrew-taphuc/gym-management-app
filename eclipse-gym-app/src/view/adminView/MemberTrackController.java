...
public class MemberTrackController {
    ...
    @FXML
    private TableView<Membership> tblMemberships;
    @FXML
    private TableView<Attendance> tblAttendance;
    @FXML
    private Button btnCheckinGym;
    @FXML
    private Button btnCheckinPT;
    @FXML
    private Button btnActivate;

    @FXML
    private TableColumn<Membership, String> colPlanName;
    @FXML
    private TableColumn<Membership, String> colStartDate;
    @FXML
    private TableColumn<Membership, String> colEndDate;
    @FXML
    private TableColumn<Membership, String> colStatus;

    @FXML
    private TableColumn<Attendance, String> colCheckinDate;
    @FXML
    private TableColumn<Attendance, String> colCheckinTime;
    @FXML
    private TableColumn<Attendance, String> colMembership;
    @FXML
    private TableColumn<Attendance, String> colType;
    @FXML
    private TableColumn<Attendance, String> colTrainer;
    ...
    public void handleCheckinPT() {
        ...
        List<TrainingRegistration> ptRegistrations = TrainingRegistrationController
                .getActivePTRegistrationsByMemberId(member.getMemberId());
        ...
        List<model.TrainingSchedule> schedules = TrainingScheduleController
                .getScheduledPTByMemberId(member.getMemberId());
    ...
    private void showScheduleTableDialog(List<model.TrainingSchedule> schedules, Membership activeMembership,
            TrainingRegistration ptRegistration) {
        ...
        colRoom.setCellValueFactory(
                cellData -> new SimpleStringProperty(String.valueOf(cellData.getValue().getRoomId())));
    ...
    public void initialize() {
        ...
        colPlanName.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getPlanName()));
        ...
        // Attendance
        colCheckinDate.setCellValueFactory(cellData -> new SimpleStringProperty(
                cellData.getValue().getCheckInTime() != null
                        ? cellData.getValue().getCheckInTime().toLocalDate().format(dateFormatter)
                        : ""));
        colCheckinTime.setCellValueFactory(cellData -> new SimpleStringProperty(
                cellData.getValue().getCheckInTime() != null
                        ? cellData.getValue().getCheckInTime().toLocalTime().format(timeFormatter)
                        : ""));
        colMembership.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getPlanName()));
        ...
        colTrainer.setCellValueFactory(cellData -> new SimpleStringProperty(
                cellData.getValue().getTrainerName() != null ? cellData.getValue().getTrainerName() : "-"));
    }
}
