...
public class WorkoutsController {
    ...
    public void initialize() {
        ...
        if (currentUser != null) {
            ...
            int trainerId = trainerController.getTrainerIdByUserId(currentUser.getUserId());
            System.out.println("[DEBUG] userId: " + currentUser.getUserId() + ", trainerId: " + trainerId);
            loadSchedulesByTrainer(trainerId);
        }
    }
    ...
    private void loadSchedulesByTrainer(int trainerId) {
        ...
        for (TrainingSchedule ts : list) {
            System.out.println("ScheduleID: " + ts.getScheduleId() + ", Member: " + ts.getMemberName() + ", TrainerID: "
                    + ts.getTrainerId() + ", Date: " + ts.getScheduleDate());
        }
